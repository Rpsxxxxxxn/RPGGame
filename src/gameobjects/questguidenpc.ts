...
export class QuestGuideNPC extends GameObject {
    ...
    constructor(engine: Main) {
        super(ObjectType.Character, engine.getObjectId, QuestGuideNPC.name);
    ...
    public onUpdate(engine: Main): void {
        this._debugText.setText = `${QuestGuideNPC.name} x:${this._position.x} y:${this._position.y}`;
